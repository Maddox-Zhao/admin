...
public enum EnumBilling_Paipai_Detail {
	No_Permission("508","对不起，该用户没有权限，可能是由于未登录等原因1717"),
	Server_Exception("4096","服务器出现错误，请稍后再试（服务器产生异常）17"),
	Protocol_Exception("4097","服务器出现错误，请稍后再试（服务器后台协议返回错误）17"),
	Creating_Cache("4098","服务器出现错误，请稍后再试（服务器正在建设缓存）17"),
	Initialization_Exception("4099","服务器出现错误，请稍后再试（环境初始化错误）17"),
	Not_Support_Argument("8192","对不起，服务器不支持该参数1717"),
	Parameter_Exception("8193","对不起，参数设置错误17"),
	Permissions_No_Passed("12288","对不起，您无权访问该服务（鉴权不通过）1717"),
	No_Access_Interface("12289","对不起，您无权访问该服务（外网无权访问该服务接口）1717"),
	Sign_Validation_Failure("12290","对不起，sign校验失败，数据被篡改或sign计算方法有误17"),
	Access_frequency_is_too_fast("12291","对不起，您的访问频率太快，请稍后再试17");
