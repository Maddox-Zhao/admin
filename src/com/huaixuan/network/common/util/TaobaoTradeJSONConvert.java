...
//		}
		...
		if(json.has(ApiConstants.ORDERS)){
			newTrade.setOrders(convertJsonArrayToOrderList(json.getJSONObject(ApiConstants.ORDERS).getJSONArray("order")));
		}
...
//		}
	...
	public static Order convertJsonToOrder(JSONObject json) throws JSONException{
		 ...
		 */
		if(json.has(ApiConstants.SELLER_TYPE)) {
			order.setSellerType(json.getString(ApiConstants.SELLER_TYPE));
		}
