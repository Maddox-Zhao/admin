...
public class GoodsAddValidator extends ValangValidator{
	...
	public void validate(Object obj, Errors errors) {
        ...
        if(goods.getIsAgent().equals("y")){
        	if(goods.getAgentPrice()==null){
        		errors.rejectValue("agentPrice", "", "代销价不能为空");
        	}else if(goods.getAgentPrice().doubleValue() > 1000000){
