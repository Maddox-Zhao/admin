...
public class SendDLMailToUserThread implements Runnable
{	

	private final Map<String, Map<String,List<SendMailInfo>>> sendMap;
	...
	public SendDLMailToUserThread(Map<String, Map<String,List<SendMailInfo>>> sendMap,MailEngine mailEngine,String title,String templtName)
	{
	...
	{
		// 发送邮件
		Set<Entry<String, Map<String,List<SendMailInfo>>>> set = sendMap.entrySet();
		Iterator<Entry<String, Map<String,List<SendMailInfo>>>> ite = set.iterator();
		...
		while (ite.hasNext())
		{
			...
			if(email == null || !isEmail(email))
				continue;
			Map<String,List<SendMailInfo>> list = sendMap.get(email);
