...
public class BarCodeServlet extends HttpServlet {
	...
	private static final long serialVersionUID = -5720733074022158755L;
	...
	private BarCode getChart(HttpServletRequest httpservletrequest) {
        ...
        if(barcode == null)
            barcode = new BarCode();
		try {
			setParameter(barcode,"barType", httpservletrequest.getParameter("barType"));
			if (httpservletrequest.getParameter("width") != null && httpservletrequest.getParameter("height") != null) {
				setParameter(barcode,"width", httpservletrequest.getParameter("width"));
				setParameter(barcode,"height", httpservletrequest.getParameter("height"));
				setParameter(barcode,"autoSize", "n");
			}
			setParameter(barcode,"code", httpservletrequest.getParameter("code"));
			setParameter(barcode,"st", httpservletrequest.getParameter("st"));
			setParameter(barcode,"textFont", httpservletrequest.getParameter("textFont"));
			setParameter(barcode,"fontColor", httpservletrequest.getParameter("fontColor"));
			setParameter(barcode,"barColor", httpservletrequest.getParameter("barColor"));
			setParameter(barcode,"backColor", httpservletrequest.getParameter("backColor"));
			setParameter(barcode,"rotate", httpservletrequest.getParameter("rotate"));
			setParameter(barcode,"barHeightCM", httpservletrequest.getParameter("barHeightCM"));
			setParameter(barcode,"x", httpservletrequest.getParameter("x"));
			setParameter(barcode,"n", httpservletrequest.getParameter("n"));
			setParameter(barcode,"leftMarginCM", httpservletrequest.getParameter("leftMarginCM"));
			setParameter(barcode,"topMarginCM", httpservletrequest.getParameter("topMarginCM"));
			setParameter(barcode,"checkCharacter", httpservletrequest.getParameter("checkCharacter"));
			setParameter(barcode,"checkCharacterInText", httpservletrequest.getParameter("checkCharacterInText"));
			setParameter(barcode,"Code128Set", httpservletrequest.getParameter("Code128Set"));
			setParameter(barcode,"UPCESytem", httpservletrequest.getParameter("UPCESytem"));
	...
	public void setParameter(BarCode barcode, String s, String s1) {
		if (s1 != null)
			if (s.equals("code"))
				barcode.code = s1;
