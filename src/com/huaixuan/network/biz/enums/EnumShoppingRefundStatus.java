 ...
 *
 */
public enum EnumShoppingRefundStatus {
	STOCK_NEW("stock_new", "退货新建"),
    STOCK_CHECKED("stock_checked","已验收"),
    STOCK_FINISHED("stock_finished","退货完成"),
    STOCK_CLOSE("stock_close","退货关闭");

    private String code;
    private String name;
    private int index;

    EnumShoppingRefundStatus(String code, String name) {
        this.code = code;
        this.name = name;
    }
