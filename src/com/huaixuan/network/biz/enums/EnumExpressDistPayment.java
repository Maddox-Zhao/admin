 ...
 *
 */
public enum EnumExpressDistPayment {

	PAYMENT_FIRST("payment_first", "先款后货"),
    GOODS_FIRST("goods_first","货到付款"),
    PERIOD_PAY("period_pay","周期结算"),
    ALL("all", "全部支持");

    private String code;
    private String name;

    EnumExpressDistPayment(String code, String name) {
        this.code = code;
        this.name = name;
    }
    ...
    public static Map<String, String> toMap() {
        Map<String, String> enumDataMap = new TreeMap<String, String>(new Comparator() {
            public int compare(Object element1, Object element2) {
                ...
                if("period_pay".equalsIgnoreCase(eOp1)){
                    ob1Index=3;
                }
                if("period_pay".equalsIgnoreCase(eOp2)){
                    ob2Index=3;
                }
        ...
        enumDataMap.put(PERIOD_PAY.getKey(), PERIOD_PAY.getValue());
