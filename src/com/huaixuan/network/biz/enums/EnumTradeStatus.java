...
public enum EnumTradeStatus  {
	WAIT_SELLER_CONFIRM("wait_seller_confirm", "等待卖家确认"),
	WAIT_BUYER_CONFIRM("wait_buyer_confirm", "等待买家确认"),
    ...
    EnumTradeStatus(String code, String name) {
        this.code = code;
        this.name = name;
    }
    ...
    public static Map<String, String> toMap() {
        Map<String, String> enumDataMap = new TreeMap<String, String>(new Comparator() {
            public int compare(Object element1, Object element2) {
                ...
                int ob1Index=0;
                int ob2Index=0;
                if("wait_seller_confirm".equalsIgnoreCase(eOp1)){
                    ob1Index=1;
                }
                if("wait_seller_confirm".equalsIgnoreCase(eOp2)){
                    ob2Index=1;
                }
                if("wait_buyer_confirm".equalsIgnoreCase(eOp1)){
                    ob1Index=2;
                }
                if("wait_buyer_confirm".equalsIgnoreCase(eOp2)){
                    ob2Index=2;
                }
        ...
        enumDataMap.put(WAIT_SELLER_CONFIRM.getKey(), WAIT_SELLER_CONFIRM.getValue());
        enumDataMap.put(WAIT_BUYER_CONFIRM.getKey(), WAIT_BUYER_CONFIRM.getValue());
