 ...
 *
 */
public enum EnumShoppingListType {
	SHOPPING_TYPE_N("n", "普通"),
    SHOPPING_TYPE_W("w","批发");

    private String code;
    private String name;
    private int index;

    EnumShoppingListType(String code, String name) {
        this.code = code;
        this.name = name;
    }
    ...
    public static Map<String, String> toMap() {
        ...
        enumDataMap.put(SHOPPING_TYPE_N.getKey(), SHOPPING_TYPE_N.getValue());
        enumDataMap.put(SHOPPING_TYPE_W.getKey(), SHOPPING_TYPE_W.getValue());
        return enumDataMap;
    }
}
