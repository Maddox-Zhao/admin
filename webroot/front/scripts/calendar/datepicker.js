...
function CalendarCellsClick(oCell,oInstance)
{
	...
	if(document.getElementById('CalendarIframe')){document.getElementById('CalendarIframe').style.display="none";}
}
    ...
    if(oInputSrc&&oInstance) 
    {
       // CalendarDiv=document.all[oInstance.sDIVID];
        ...
        if(document.all){
		  ...
		  if(CalendarIframe){CalendarIframe.style.pixelLeft=CalendargetPos(oInputSrc,"Left");}
          CalendarDiv.style.pixelTop=CalendargetPos(oInputSrc,"Top") + oInputSrc.offsetHeight;
		  if(CalendarIframe){CalendarIframe.style.pixelTop=CalendargetPos(oInputSrc,"Top") + oInputSrc.offsetHeight;}
        }else{
		  ...
		  if(CalendarIframe){CalendarIframe.style.left=CalendargetPos(oInputSrc,"Left") + "px";}
          CalendarDiv.style.top=CalendargetPos(oInputSrc,"Top") + oInputSrc.offsetHeight + "px";
		  if(CalendarIframe){CalendarIframe.style.top=CalendargetPos(oInputSrc,"Top") + oInputSrc.offsetHeight + "px";}
        }
        CalendarDiv.style.display=(CalendarDiv.style.display=="none")?"":"none";
		if(CalendarIframe){CalendarIframe.style.display=(CalendarIframe.style.display=="none")?"":"none";}
    }   
